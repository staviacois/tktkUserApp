const text = {
  ...
  "FillInfosView": {
    ...
    "label_fillinfos_button": "Continuer",
    "error_empty": "Remplissez ce champ",
    "error_invalid_email": "Ce n'est pas un email valide",
    "error_invalid_npa": "Ce n'est pas un NPA valide",
    "generic_error_message": "Une erreur s'est produite",
    "text_header": "Première connexion",
    "text_intro": "C'est votre première connexion ? Merci de remplir ce formulaire avant de passer à la suite"
  },
  "SignInView": {
    "form_label": {
      "email": "Email",
