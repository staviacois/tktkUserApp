...
export default class AccountView extends Component {
  ...
  getText(code, noPrefix) {
    return text.getText((noPrefix ? "" : "AccountView.") + code);
  }
        ...
        <Content>
          <Form>
            <Item disabled style={nativeStyles.input} stackedLabel>
              ...
              <Input disabled onChangeText={(name) => this.setState({name, nameError: ""})} value={name}/>
            </Item>
            <Item disabled style={nativeStyles.input} stackedLabel>
              <Label>{this.getText('label_tel')}</Label>
              <Input disabled onChangeText={(tel) => this.setState({tel, telError: ""})} value={tel}/>
            </Item>
            <Item disabled style={nativeStyles.input} stackedLabel>
              <Label>{this.getText('label_address')}</Label>
              <Input disabled onChangeText={(address) => this.setState({address, addressError: ""})} value={address}/>
            </Item>
          </Form>
        </Content>
        <Footer>
